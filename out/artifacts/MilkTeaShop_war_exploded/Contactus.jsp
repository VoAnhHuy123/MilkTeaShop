...
<div id="information-contact" class="container">
    <ul class="breadcrumb">
        ...
        <li><a href="https://demo.codezeel.com/opencart/OPC04/OPC040082/index.php?route=information/contact">Contact
            Us</a></li>
    </ul>
    <div class="row">
        ...
        <div id="content" class="col-sm-9">
                ...
                <div class="panel-body">
                    <div class="row contact-info">
                        <div class="left">
                            ...
                            <div class="address-detail"><strong>Fodder Restaurant Store</strong>
                                <address>
                                    Address 1
                                </address>
                        ...
                        <div class="right">
                            <div class="map">
                                <script type="text/javascript"
                                        src="http://www.webestools.com/google_map_gen.js?lati=21.182785&long=72.831834&zoom=4&width=350&height=200&mapType=normal&map_btn_normal=yes&map_btn_satelite=yes&map_btn_mixte=yes&map_small=yes&marqueur=yes&info_bulle="></script>
                            </div>
                        </div>
                        <div class="col-sm-3">
                        </div>
            ...
            <form action="https://demo.codezeel.com/opencart/OPC04/OPC040082/index.php?route=information/contact"
                ...
                <fieldset>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" value="Võ" id="input-name" class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-email">E-Mail Address</label>
                        <div class="col-sm-10">
                            <input type="text" name="email" value="huy@1gmail.com" id="input-email"
                                   class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group required">
