...
<div id="information-contact" class="container">
    <ul class="breadcrumb">
        ...
        <li><a href="https://demo.codezeel.com/opencart/OPC04/OPC040082/index.php?route=information/contact">Contact Us</a></li>
    </ul>
    <div class="row"><aside id="column-left" class="col-sm-3 hidden-xs">
        ...
        <div id="content" class="col-sm-9">
            ...
            <form action="https://demo.codezeel.com/opencart/OPC04/OPC040082/index.php?route=information/contact" method="post" enctype="multipart/form-data" class="form-horizontal">
                <fieldset>
                    <h3>Contact Form</h3>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="email" value="huy@1gmail.com" id="input-email" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group required">
