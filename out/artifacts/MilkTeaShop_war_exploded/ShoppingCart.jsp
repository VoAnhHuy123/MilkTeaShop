    ...
    <div class="row">
            ...
            <form action="https://demo.codezeel.com/opencart/OPC04/OPC040082/index.php?route=checkout/cart/edit"
                ...
                <div class="table-responsive">
                    <table class="table table-bordered shopping-cart">
                        ...
                        <tr>
                            <td class="text-center"><a
                                    ...
                                    src="https://demo.codezeel.com/opencart/OPC04/OPC040082/image/cache/catalog/01-85x85.jpg"
                                    alt="Accusantium Doloremque" title="Accusantium Doloremque" class="img-thumbnail"/></a>
                            </td>
                            <td class="text-left"><a
                                    href="https://demo.codezeel.com/opencart/OPC04/OPC040082/index.php?route=product/product&amp;product_id=47">Accusantium
                                Doloremque</a> <br/>
                  ...
                  <button type="button" data-toggle="tooltip" title="Remove" class="btn btn-danger"
                          onclick="cart.remove('80');"><i class="fa fa-times-circle"></i></button>
                  </span></div>
                            </td>
                        ...
                        <tr>
                            <td class="text-center"><a
                                    href="https://demo.codezeel.com/opencart/OPC04/OPC040082/index.php?route=product/product&amp;product_id=48"><img
                                    src="https://demo.codezeel.com/opencart/OPC04/OPC040082/image/cache/catalog/15-85x85.jpg"
                                    alt="Voluptates Repudiandae" title="Voluptates Repudiandae" class="img-thumbnail"/></a>
                            </td>
                            <td class="text-left"><a
                                    href="https://demo.codezeel.com/opencart/OPC04/OPC040082/index.php?route=product/product&amp;product_id=48">Voluptates
                                Repudiandae</a></td>
                            <td class="text-left">product 20</td>
                            <td class="text-left">
                                <div class="input-group btn-block" style="max-width: 200px;">
                                    <input type="text" name="quantity[79]" value="5" size="1" class="form-control"/>
                                    <span class="input-group-btn">
                  <button type="submit" data-toggle="tooltip" title="Update" class="btn btn-primary"><i
                          class="fa fa-refresh"></i></button>
                  <button type="button" data-toggle="tooltip" title="Remove" class="btn btn-danger"
                          onclick="cart.remove('79');"><i class="fa fa-times-circle"></i></button>
                  </span></div>
                            </td>
        ...
        <input type="button" value="Apply Coupon" id="button-coupon" data-loading-text="Loading..."
               class="btn btn-primary"/>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title"><a href="#collapse-shipping" class="accordion-toggle"
                                                   data-toggle="collapse" data-parent="#accordion">Estimate Shipping
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="postcode" value="71308" placeholder="Post Code"
