...
<body class="account-order layout-2 left-col">
    ...
    <div class="row"><aside id="column-left" class="col-sm-3 hidden-xs">
        ...
        <div id="content" class="col-sm-9">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td class="text-left">Võ Huy</td>
                        <td class="text-right">1</td>
                        <td class="text-left">Pending</td>
                        <td class="text-right">$90.00</td>
                        <td class="text-left">24/10/2019</td>
                        <td class="text-right"><a href="https://demo.codezeel.com/opencart/OPC04/OPC040082/index.php?route=account/order/info&amp;order_id=8" data-toggle="tooltip" title="View" class="btn btn-info"><i class="fa fa-eye"></i></a></td>
                    </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="buttons clearfix">
                <div class="pull-right"><a href="https://demo.codezeel.com/opencart/OPC04/OPC040082/index.php?route=account/account" class="btn btn-primary">Continue</a></div>
            </div>
        </div>
    </div>
</div>
