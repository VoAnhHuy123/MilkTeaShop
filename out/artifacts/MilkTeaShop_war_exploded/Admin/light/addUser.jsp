        ...
        <div class="page-header-inner ">
            ...
            <div class="page-logo">
                <a>
                    ...
                    <span class="logo-default">Ta Tua</span> </a>
            </div>
            <!-- logo end -->
            ...
            <div class="page-title" style="font-size: 20px; margin-top: 10px">User Add
                    ...
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="card-head">
                                ...
                                <form class="card-body row" action="<%=Util.fullPath("AddUser")%>" method="post">
