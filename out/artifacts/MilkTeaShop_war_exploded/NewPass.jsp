...
<div id="account-forgotten" class="container">
    ...
    <div class="row">
        ...
        <div id="content" class="col-sm-9">
            ...
            %>
            <form action="<%=Util.fullPath("FinalForgotPass?email=" + email)%>" method="post" class="form-horizontal">
                <fieldset>
                    <legend>New Password</legend>
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-email">New Password</label>
                        <div class="col-sm-10">
                            <input type="password" name="new-pass" value="" placeholder="New-Password" id="input-email"
                                   class="form-control"/>
                        </div>
                    </div>
                </fieldset>
