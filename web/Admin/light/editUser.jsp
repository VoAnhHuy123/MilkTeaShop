...
<!-- Mirrored from radixtouch.in/templates/admin/smart/source/light/edit_professor.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Oct 2019 07:56:39 GMT -->
<head>
...
<div class="page-wrapper">
	...
	<div class="page-header navbar navbar-fixed-top">
		<div class="page-header-inner ">
			...
			<div class="page-title" style="font-size: 20px; margin-top: 10px">User Edit
				<ol class="breadcrumb page-breadcrumb pull-right" style="margin: -2px 60px 0px 0px; border-radius: 25px;">
					...
					<li><a class="parent-item" href="<%=Util.fullPath("AllUser")%>">User List</a>&nbsp;<i class="fa fa-angle-right"></i>
					</li>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="card-box">
							...
							<form class="card-body row" action="<%=Util.fullPath("EditUser")%>" method="post">
								<%
								ResultSet resultSet = (ResultSet) request.getAttribute("set");
								...
								<div class="col-lg-6 p-t-20">
									<div
										...
										<input class="mdl-textfield__input" type="text" id="txtFirstName"
											   name="firstname" value="<%=resultSet.getString(2)%>">
								...
								<div class="col-lg-6 p-t-20">
									<div
										...
										<input class="mdl-textfield__input" type="text" id="txtLasttName"
											   name="lastname" value="<%=resultSet.getString(3)%>">
								...
								<div class="col-lg-6 p-t-20">
									<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<input class="mdl-textfield__input" type="email" id="txtemail" name="email" value="<%=resultSet.getString(4)%>">
								...
								<div class="col-lg-6 p-t-20">
									<div
										...
										<input class="mdl-textfield__input" type="password" id="txtPwd"
											   name="password" value="<%=resultSet.getString(5)%>">
								...
								<div class="col-lg-6 p-t-20">
									<div
										...
										<input class="mdl-textfield__input" type="password" id="txtConfirmPwd"
											   name="confirmpassword" value="<%=resultSet.getString(5)%>">
								...
								<div class="col-lg-6 p-t-20">
									<div
										...
										<input class="mdl-textfield__input" type="text"
											   pattern="-?[0-9]*(\.[0-9]+)?" id="text5" name="mobile"  value="<%=resultSet.getString(6)%>">
								...
								<div class="col-lg-6 p-t-20">
									<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
										<input class="mdl-textfield__input" type="text" id="number" name="active"  value="<%=resultSet.getString(7)%>">
								...
								<div class="col-lg-12 p-t-20 text-center">
									...
									<a href="<%=Util.fullPath("AllUser")%>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-default">
										Cancel
									</a>
								</div>
								<%}%>
