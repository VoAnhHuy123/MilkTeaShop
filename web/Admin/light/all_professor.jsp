...
<head>
    ...
    <!-- icons -->
    <link href="<%=Util.fullPath("Admin/light/fonts/simple-line-icons/simple-line-icons.min.css")%>" rel="stylesheet" type="text/css" />
    <link href="<%=Util.fullPath("Admin/light/fonts/font-awesome/css/font-awesome.min.css")%>" rel="stylesheet" type="text/css" />
    <link href="<%=Util.fullPath("Admin/light/fonts/material-design-icons/material-icon.css")%>" rel="stylesheet" type="text/css" />
    <!--bootstrap -->
    <link href="<%=Util.fullPath("Admin/assets/plugins/bootstrap/css/bootstrap.min.css")%>" rel="stylesheet" type="text/css" />
    <!-- data tables -->
    <link href="<%=Util.fullPath("Admin/assets/plugins/datatables/plugins/bootstrap/dataTables.bootstrap4.min.css")%>" rel="stylesheet"
          type="text/css" />
    <!-- Material Design Lite CSS -->
    <link rel="stylesheet" href="<%=Util.fullPath("Admin/assets/plugins/material/material.min.css")%>">
    <link rel="stylesheet" href="<%=Util.fullPath("Admin/assets/css/material_style.css")%>">
    <!-- Theme Styles -->
    <link href="<%=Util.fullPath("Admin/assets/css/theme/light/theme_style.css")%>" rel="stylesheet" id="rt_style_components" type="text/css" />
    <link href="<%=Util.fullPath("Admin/assets/css/theme/light/style.css")%>" rel="stylesheet" type="text/css" />
    <link href="<%=Util.fullPath("Admin/assets/css/plugins.min.css")%>" rel="stylesheet" type="text/css" />
    <link href="<%=Util.fullPath("Admin/assets/css/responsive.css")%>" rel="stylesheet" type="text/css" />
    <link href="<%=Util.fullPath("Admin/assets/css/theme/light/theme-color.css")%>" rel="stylesheet" type="text/css" />
    <!-- favicon -->
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown language-switch">
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"> <img
                                src="<%=Util.fullPath("Admin/assets/img/flags/gb.png")%>" class="position-left" alt=""> English <span
                                class="fa fa-angle-down"></span>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a class="deutsch"><img src="<%=Util.fullPath("Admin/assets/img/flags/de.png")%>" alt=""> Deutsch</a>
                            </li>
                            <li>
                                <a class="ukrainian"><img src="<%=Util.fullPath("Admin/assets/img/flags/ua.png")%>" alt=""> Українська</a>
                            </li>
                            <li>
                                <a class="english"><img src="<%=Util.fullPath("Admin/assets/img/flags/gb.png")%>" alt=""> English</a>
                            </li>
                            <li>
                                <a class="espana"><img src="<%=Util.fullPath("Admin/assets/img/flags/es.png")%>" alt=""> España</a>
                            </li>
                            <li>
                                <a class="russian"><img src="<%=Util.fullPath("Admin/assets/img/flags/ru.png")%>" alt=""> Русский</a>
                            </li>
                        </ul>
                    </li>
                    <!-- end language menu -->
                            ...
                            <li>
                                <ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
                                    <li>
                                        <a href="#">
												<span class="photo">
													<img src="<%=Util.fullPath("Admin/assets/img/prof/prof2.jpg")%>" class="img-circle" alt="">
												</span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
												<span class="photo">
													<img src="<%=Util.fullPath("Admin/assets/img/prof/prof3.jpg")%>" class="img-circle" alt="">
												</span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
												<span class="photo">
													<img src="<%=Util.fullPath("Admin/assets/img/prof/prof1.jpg")%>" class="img-circle" alt="">
												</span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
												<span class="photo">
													<img src="<%=Util.fullPath("Admin/assets/img/prof/prof8.jpg")%>" class="img-circle" alt="">
												</span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
												<span class="photo">
													<img src="<%=Util.fullPath("Admin/assets/img/prof/prof5.jpg")%>" class="img-circle" alt="">
												</span>
                                            <span class="subject">
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true">
                            <img alt="" class="img-circle " src="<%=Util.fullPath("Admin/assets/img/dp.jpg")%>" />
            ...
            <ul id="themecolors">
                ...
                <li class="complete">
                    <div class="theme-color layout-theme">
                        ...
                        <a href="http://radixtouch.in/templates/admin/smart/source/dark/all_professors.html" data-theme="dark"><span class="head"></span><span
                                class="cont"></span></a>
                    </div>
                </li>
                <li>
                        ...
                        <li class="sidebar-user-panel">
                            <div class="user-panel">
                                <div class="pull-left image">
                                    <img src="<%=Util.fullPath("Admin/assets/img/dp.jpg")%>" class="img-circle user-img-circle"
                                         alt="User Image" />
                                </div>
                                                        ...
                                                        %>
                                                            <tr class="odd gradeX">
                                                                <td class="patient-img">
                                                                    <img src="<%=Util.fullPath("Admin/assets/img/prof/prof1.jpg")%>"
                                                                         alt="">
                                                                </td>
                                                                <td><%=rs.getString("firstname")%></td>
                                                                <td class="left"><%=rs.getString("lastname")%></td>
                                                                <td class="left"><%=rs.getString("email")%></td>
                                                                <td class="left"><%=rs.getString("phone")%></td>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="card card-box">
                                                <div class="card-body no-padding ">
                                                    <div class="doctor-profile">
                                                        <img src="<%=Util.fullPath("Admin/assets/img/prof/prof10.jpg")%>" class="doctor-pic"
                                                             alt="">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card card-box">
                                                <div class="card-body no-padding ">
                                                    <div class="doctor-profile">
                                                        <img src="<%=Util.fullPath("Admin/assets/img/prof/prof1.jpg")%>" class="doctor-pic"
                                                             alt="">
                                                        <div class="profile-usertitle">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card card-box">
                                                <div class="card-body no-padding ">
                                                    <div class="doctor-profile">
                                                        <img src="<%=Util.fullPath("Admin/assets/img/prof/prof2.jpg")%>" class="doctor-pic"
                                                             alt="">
                                                        <div class="profile-usertitle">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="card card-box">
                                                <div class="card-body no-padding ">
                                                    <div class="doctor-profile">
                                                        <img src="<%=Util.fullPath("Admin/assets/img/prof/prof3.jpg")%>" class="doctor-pic"
                                                             alt="">
                                                        <div class="profile-usertitle">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card card-box">
                                                <div class="card-body no-padding ">
                                                    <div class="doctor-profile">
                                                        <img src="<%=Util.fullPath("Admin/assets/img/prof/prof4.jpg")%>" class="doctor-pic"
                                                             alt="">
                                                        <div class="profile-usertitle">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card card-box">
                                                <div class="card-body no-padding ">
                                                    <div class="doctor-profile">
                                                        <img src="<%=Util.fullPath("Admin/assets/img/prof/prof5.jpg")%>" class="doctor-pic"
                                                             alt="">
                                                        <div class="profile-usertitle">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="card card-box">
                                                <div class="card-body no-padding ">
                                                    <div class="doctor-profile">
                                                        <img src="<%=Util.fullPath("Admin/assets/img/prof/prof6.jpg")%>" class="doctor-pic"
                                                             alt="">
                                                        <div class="profile-usertitle">
                        ...
                        <div class="chat-sidebar-list">
                            <div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd"
                                ...
                                <ul class="media-list list-items">
                                    ...
                                    <li class="media"><img class="media-object" src="<%=Util.fullPath("Admin/assets/img/prof/prof2.jpg")%>"
                                                           width="35" height="35" alt="...">
                                        <i class="busy dot"></i>
                                        <div class="media-body">
                                ...
                                <ul class="media-list list-items">
                                    ...
                                    <li class="media">
                                        ...
                                        </div> <img class="media-object" src="<%=Util.fullPath("Admin/assets/img/prof/prof9.jpg")%>"
                                                    width="35" height="35" alt="...">
                                        <i class="offline dot"></i>
                                        <div class="media-body">
