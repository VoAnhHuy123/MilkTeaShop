...
<div id="account-forgotten" class="container">
    ...
    <div class="row"><aside id="column-left" class="col-sm-3 hidden-xs">
        ...
        <div id="content" class="col-sm-9">
            ...
            <form action="https://demo.codezeel.com/opencart/OPC04/OPC040082/index.php?route=account/forgotten" method="post" enctype="multipart/form-data" class="form-horizontal">
                <fieldset>
                ...
                <div class="buttons clearfix">
                    <div class="pull-left"><a href="indexe223.html?route=account/login" class="btn btn-default">Back</a></div>
